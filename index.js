...
let cardReduction = GAMES_JSON.reduce((acc, current) => {
    return acc + current["backers"];
}, 0);

// set the inner HTML using a template literal and toLocaleString to get a number with commas
cardReduction=cardReduction.toLocaleString('en-US');
...
const [firstBest, secondBest, ] = [sortedGames[0], sortedGames[1], ...sortedGames];
// create a new element to hold the name of the top pledge game, then append it to the correct element
const topFirstName = document.createElement("p");
